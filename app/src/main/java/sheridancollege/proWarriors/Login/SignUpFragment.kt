                       ...
                       if (task.isSuccessful) {
                          /* Toast.makeText(
                           ...
                           auth.currentUser!!.sendEmailVerification().addOnCompleteListener{ task ->
                               if (task.isSuccessful) {
                                   Toast.makeText(
                                       view.context, "Registered Successfully and Verification " +
                                               "Email sent" ,
                                       Toast.LENGTH_SHORT
                                   ).show()

                                       val student = Student(username,firstName.text.toString(),lastName.text.toString(),email.text.toString(),address.text.toString(),phoneNo.text.toString(),false)
                                   database.child("Students").child(username!!).setValue(student)
                                   firstName.text = ""
                                   lastName.text=""
                                   address.text=""
                                   phoneNo.text=""
